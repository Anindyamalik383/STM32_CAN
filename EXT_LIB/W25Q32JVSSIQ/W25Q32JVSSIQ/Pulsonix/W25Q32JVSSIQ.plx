...
//641947/1582932/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "W25Q32JVSSIQ" (originalName "W25Q32JVSSIQ")
	...
	(compDef "W25Q32JVSSIQ" (originalName "W25Q32JVSSIQ") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "W25Q32JVSSIQ"))
		...
		(attr "Mouser Part Number" "454-W25Q32JVSSIQ")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Winbond/W25Q32JVSSIQ?qs=qSfuJ%252Bfl%2Fd4PGZSN0WxfCA%3D%3D")
		(attr "Manufacturer_Name" "Winbond")
		(attr "Manufacturer_Part_Number" "W25Q32JVSSIQ")
		(attr "Description" "32Mb Serial NOR Flash 133MHz SOP8")
		(attr "<Hyperlink>" "https://www.winbond.com/hq/search-resource-file.jsp?partNo=W25Q32JVSSIQ&type=datasheet")
		(attr "<Component Height>" "2.16")
		(attr "<STEP Filename>" "W25Q32JVSSIQ.stp")
